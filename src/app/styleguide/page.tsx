    ...
    <>
      ...
      >
        ...
        <p className="mt-6 max-w-2xl text-sm leading-relaxed text-grey-400">
          ...
          foliemand eller en broderiskærer beder om. PDF er samme vektor pakket
          til tryk. PNG er 2400 px bred med gennemsigtig bund, til alt hvor der
          ikke kan lægges en vektor ind: sociale medier, PowerPoint, Word.
        </p>
      </Blok>
        ...
        <div className="grid gap-8 md:grid-cols-[10rem_minmax(0,1fr)]">
          ...
          <div>
            ...
            <p className="mt-4 max-w-2xl leading-relaxed text-grey-400">
              Den bruges ét sted: på dét, folk skal trykke på. På sitet er det
              den primære knap — og den tynde linje i toppen, der viser, hvor
              langt man er nået ned ad siden. Den er sidens eneste undtagelse,
              og den er funktionel. Sætter du accenten på overskrifter, streger
              eller flader, holder den op med at betyde “tryk her”, og så er der
              ikke noget tilbage til at sige det.
            </p>
      ...
      >
        <div className="grid gap-10">
          ...
          >
            <p className="label-mono text-grey-400">Ydelser · Cases · 02 / 03</p>
          </Spec>
          <Spec
            midt={false}
        ...
        <p className="mt-8 max-w-2xl text-sm leading-relaxed text-grey-400">
          ...
          overskrift er brudt i linjer i hånden og kan derfor ikke ombryde sig ud
          af en for smal spalte — uden loftet bliver den klippet af på hver
          eneste telefon.
        </p>
      </Blok>
      ...
      >
        ...
        <p className="max-w-2xl leading-relaxed text-grey-400">
          ...
          <strong className="font-medium text-paper">uden for</strong> motivet,
          med negativ afstand. Hvide hårstreger oven på et foto forsvinder mod
          himmel og lyst træ, og så er rammen kun halvt synlig. Uden for står de
          på sitets sorte bund og kan ses hele vejen rundt.
        </p>
      </Blok>
      ...
      >
        <div className="grid gap-8 lg:grid-cols-3">
          <Spec className="min-h-36" note="primary · den eneste lilla flade · én per skærmbillede">
            <Button href="/kontakt">Book en uforpligtende snak</Button>
          </Spec>
          <Spec className="min-h-36" note="secondary · hårstregskant, lyser op ved hover">
            <Button href="/cases" variant="secondary">
              Se cases <ArrowRight />
            </Button>
          </Spec>
          <Spec className="min-h-36" note="ghost · til det tredje valg, uden flade">
      ...
      >
        ...
        <p className="mt-6 max-w-2xl text-sm leading-relaxed text-grey-400">
          Håndtegnede og bevidst uden ikonbibliotek — vi bruger syv stykker, og
          en pakke på 300 kB for det ville koste mere end det smager. Alle deler
          stregvægt 1,4 og runde hjørner, så de læses som ét sæt.
        </p>
        ...
        <p className="mt-6 max-w-2xl text-sm leading-relaxed text-grey-400">
          Kortene ligger på et gitter af hårstreger: <code className="font-mono text-paper">gap-px</code>{" "}
          på grå bund, så stregen mellem dem er selve mellemrummet — ikke en
          kant, der skal flugte med naboens. Kortene er lige høje, fordi de er
          flex-kolonner i et grid, ikke fordi teksterne er lige lange.
        </p>
        ...
        <div className="grid gap-10 md:grid-cols-[18rem_minmax(0,1fr)]">
          ...
          <div className="text-sm leading-relaxed text-grey-400">
            <p>
              ...
              <strong className="font-medium text-paper">16:9</strong> til toppen
              af en case.
            </p>
            <p className="mt-4">
              Hjørnerne slås fra, hvor billedet støder op til andet indhold —
              kort med kant, gallerier med fire op. Dér ville vinklerne lægge sig
              oven i naboen eller blive til støj i mængde.
            </p>
            <p className="mt-4">
              Billeder ligger altid på{" "}
              <code className="font-mono text-paper">ink-soft</code>, mens de
              indlæses, så der aldrig blinker en hvid flade frem på en sort side.
            </p>
          </div>
        </div>
      </Blok>
        ...
        <div className="grid gap-10 md:grid-cols-2">
          ...
          >
            <div className="w-full">
              ...
              <div className="py-section">
                <p className="label-mono text-grey-600">Sektionens indhold</p>
              </div>
              <div className="h-px bg-grey-800" />
            </div>
          </Spec>
          <div className="text-sm leading-relaxed text-grey-400">
            <p>
              ...
              <code className="font-mono text-paper">Section</code>, og alle
              sider har samme yderramme:{" "}
              <code className="font-mono text-paper">max-w-320</code> med{" "}
              <code className="font-mono text-paper">px-6</code>, der bliver til{" "}
              <code className="font-mono text-paper">px-10</code> fra md.
            </p>
            <p className="mt-4">
              Sektioner adskilles af en enkelt hårstreg i{" "}
              <code className="font-mono text-paper">grey-800</code> — ikke af en
              baggrundsfarve. Det er dét, der holder sitet fladt og lader luften
              gøre arbejdet.
            </p>
            <p className="mt-4">
              Brødtekst holdes omkring 65 tegn bred. Længere linjer bliver
              trættende at læse, uanset hvor meget luft der er omkring dem.
            </p>
          </div>
        </div>
      </Blok>
      ...
      <section className="border-t border-grey-800 py-section">
        <div className="mx-auto w-full max-w-320 px-6 md:px-10">
          ...
          <p className="mt-6 max-w-2xl leading-relaxed text-grey-400">
            ...
            <code className="font-mono text-paper">python3 brand/byg.py</code> —
            ændrer geometrien sig, køres scriptet, og ikoner, delebillede og
            trykfiler følger med.
          </p>
